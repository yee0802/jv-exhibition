...
import com.example.jv_exhibition.service.ArtworkApiService;
...
public class ArtworkRepository {
    ...
    public ArtworkRepository(Application application) {
        this.artworkApiService = RetrofitInstance.getService();
    }

    public void loadArtworks(int pageNo, int pageSize) {
        Call<ArtworkResponse> call = artworkApiService.getAllArtworks(pageNo, pageSize);
